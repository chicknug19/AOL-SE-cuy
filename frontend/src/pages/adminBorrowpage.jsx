...
const AdminBorrowpage = ({ onLogout, onNavigate }) => {
  return (
    <div className="flex w-full min-h-screen bg-[#F7F8FA] font-sans text-gray-900">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col flex-shrink-0">
        ...
        <nav className="flex flex-col py-4">
          <button onClick={() => onNavigate('adminHome')} className="flex items-center gap-3 px-6 py-3 text-gray-500 hover:text-black hover:bg-gray-50 transition-colors text-sm font-semibold border-l-4 border-transparent text-left">
          ...
          {/* Active Link */}
          <button onClick={() => onNavigate('adminBorrow')} className="flex items-center gap-3 px-6 py-3 border-l-4 border-black bg-gray-50 text-black font-bold text-sm text-left">
          ...
          <button onClick={() => onNavigate('adminReturn')} className="flex items-center gap-3 px-6 py-3 text-gray-500 hover:text-black hover:bg-gray-50 transition-colors text-sm font-semibold border-l-4 border-transparent text-left">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col h-full">
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-3">
                ...
                />
                <button className="bg-[#3B82F6] hover:bg-blue-600 text-white font-bold text-sm px-6 py-2.5 rounded-lg transition-colors">
                  Scan
                </button>
              </div>
            </div>

            <div className="flex-grow flex flex-col items-center justify-center border-2 border-dashed border-gray-200 rounded-xl bg-gray-50/50 p-8 min-h-[200px]">
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-3">
                <input 
                  ...
                  className="flex-grow border border-[#93C5FD] rounded-lg px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-[#3B82F6]/50 placeholder-gray-400"
                />
                <button className="bg-gray-200 text-white font-bold text-sm px-6 py-2.5 rounded-lg cursor-not-allowed">
                  Add
                </button>
              </div>
            </div>

            <div className="flex-grow flex flex-col items-center justify-center border border-gray-200 rounded-xl bg-white p-8 min-h-[150px] mb-6">
              <p className="text-xs font-bold text-gray-500">No books in cart</p>
            </div>

            <button className="w-full bg-gray-300 text-white font-bold text-sm py-4 rounded-xl cursor-not-allowed mt-auto">
              Complete Checkout (0 books)
            </button>
          </div>
