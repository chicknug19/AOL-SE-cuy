...
// Gunakan heroBook sebagai gambar default jika buku dari database tidak punya coverUrl
import heroBook from '../assets/hero_book.png'; 

const SearchPage = () => {
  const navigate = useNavigate();
  
  // Menangkap parameter pencarian dari URL (misal dari HomePage)
  ...
  // Filter buku berdasarkan input pencarian (Judul, Pengarang, atau Kategori)
  ...
  return (
    <div className="w-full min-h-screen bg-[#F3FCFC] font-sans text-gray-800 relative pb-12">
      ...
      <div className="relative z-20 w-full px-6 md:px-12 py-4">
        <button onClick={() => navigate('/')} className="flex items-center gap-2 text-gray-500 hover:text-gray-800 transition-colors text-sm font-medium">
            ...
            <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg shadow-gray-200/50 border border-gray-100 overflow-hidden mt-1">
              ...
              <div className="p-5 pb-4">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-bold text-gray-500 text-xs">Kategori Populer</h3>
                </div>
              ...
              <div className="p-5 pt-4">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <span 
                    className="px-4 py-1.5 bg-[#F0F2F5] text-gray-800 text-xs font-bold rounded-full cursor-pointer hover:bg-gray-200 transition-colors"
                    onClick={() => setSearchQuery('IT & Tech')}
                  >
                    IT & Tech
                  </span>
                </div>
